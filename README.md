# Node.js + Drizzle ORM + Railway PostgreSQL

This is a mini-project built learning the Drizzle ORM. It sets up a simple HTTP server that interacts with a PostgreSQL database hosted on Railway.
